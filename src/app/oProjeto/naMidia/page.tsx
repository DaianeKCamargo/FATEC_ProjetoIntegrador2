  ...
  return (
    <section>
      <div className="titulo">
        <TampleteTitulo titulo="Tampets na Mídia" descricao="O projeto vem sendo reconhecido aqui na região, veja um pouco mais sobre esses momentos tão especial para nós." color="#a4dbffbb"/>
      </div>
